...
export default function CartTable() {
  ...
  const updateCartQuantity = (productId: number, quantity: number) => {
    ...
    addToCart(product as Product, quantity - (product?.quantity || 0));
  };
            ...
            >
              <td className="px-4 sm:px-6 py-4 flex items-center">
                ...
                >
                  ...
                  />
                  <span className="text-primary dark:text-light hover:underline">{item.name}</span>
                </Link>
              </td>
              ...
              <td className="px-4 sm:px-6 py-4 text-base font-light">${item.price.toFixed(2)}</td>
              <td className="px-4 sm:px-6 py-4">
                <button
